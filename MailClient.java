...
public class MailClient
{
    ...
    /**
     *El cliente de correo electrónico a través de un método llamado showStats sea capaz de mostrar 
     *por pantalla unas estadísticas que incluyan el número de mensajes enviados, el número de mensajes recibidos,
     *el número de mensajes que son spam, el porcentaje de spam 
